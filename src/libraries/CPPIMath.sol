...
library CPPIMath {
    ...
    function floorValue(uint256 protectedAmount, uint256 rateWad, uint256 secondsLeft)
        internal
        pure
        returns (uint256)
    {
    ...
    function targetRisky(uint256 nav, uint256 floor, uint256 multiplierWad)
        internal
        pure
        returns (uint256)
    {
    ...
    function driftBps(uint256 currentRisky, uint256 target, uint256 nav)
        internal
        pure
        returns (uint256)
    {
